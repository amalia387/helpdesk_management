...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Helpdesk | PT. Validata Teknologi</title>
		<meta name="description" content="Metronic admin dashboard live Sdemo. Check out all the features of the admin panel. A large number of settings, additional services and widgets." />
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											<span class="menu-link">
												...
												<span class="menu-title">List Ticket</span>
											</span>
										</div>
									</div>
								</div>
												...
												<div class="card-p mt-n20 position-relative">
													...
													<div class="row g-0">
														...
														<div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-warning fw-bold fs-6">Total Tiket</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-primary fw-bold fs-6">Client</a>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
